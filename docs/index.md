...
<section class="hero-section">
    <div class="swiper hero-carousel">
        <div class="swiper-wrapper">
            <!-- Slide 4: Residência em IA -->
            <div class="swiper-slide hero-slide hero-slide-residencia-ia">
                <div class="hero-slide-bg hero-slide-bg-residencia-ia"></div>
                <div class="hero-overlay"></div>
                <div class="hero-container">
                    <div class="hero-content">
                        <p class="hero-text hero-badge-text">
                            🔥 Inscrições abertas · Até 29/06
                        </p>
                        <h1 class="hero-title">
                            Residência em IA
                        </h1>
                        <p class="hero-text">
                            Programa presencial e gratuito com bolsa auxílio. 8 meses de formação em IA, Machine Learning e Análise de Dados em Brasília (DF).
                        </p>
                        <a href="ResidenciaIA/">
                            <button class="hero-btn hero-btn-orange">
                                Quero me inscrever
            ...
            <div class="swiper-slide hero-slide hero-slide-brasil">
                <div class="hero-slide-bg hero-slide-bg-brasil"></div>
                <div class="hero-overlay"></div>
                <div class="hero-container">
                    <div class="hero-content">
                        <h1 class="hero-title">
            ...
            <!-- Slide 3 -->
            <div class="swiper-slide hero-slide hero-slide-mepa">
                <div class="hero-slide-bg hero-slide-bg-mepa"></div>
                <div class="hero-overlay"></div>
                <div class="hero-container">
                    <div class="hero-content">
                        <h1 class="hero-title">
